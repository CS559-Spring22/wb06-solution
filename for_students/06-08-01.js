...
scene.add(light);
// Make a ground plane
/** @type {T.Mesh} */ const groundMesh = new T.Mesh(new T.BoxBufferGeometry(6, 0.1, 6), new T.MeshStandardMaterial({ color: 0x888888 }));
...
/** @type {T.ConeBufferGeometry} */ const cone = new T.ConeBufferGeometry(1, 5, 20, 20);
// Create thin cylinder
/** @type {T.CylinderBufferGeometry} */ const cylinder = new T.CylinderBufferGeometry(1, 1, 5, 20, 20);
// Make a body
